...
proc setPos*(this: SmoothMover, pos: LVecBase3): bool {.importcpp: "#.set_pos(#)".} ## \
...
proc setHpr*(this: SmoothMover, hpr: LVecBase3): bool {.importcpp: "#.set_hpr(#)".} ## \
...
proc setPosHpr*(this: SmoothMover, pos: LVecBase3, hpr: LVecBase3): bool {.importcpp: "#.set_pos_hpr(#, #)".} ## \
...
proc newCConstrainHprInterval*(name: string, duration: float64, node: NodePath, target: NodePath, wrt: bool, hprOffset: LVecBase3): CConstrainHprInterval {.importcpp: "new CConstrainHprInterval(nimStringToStdString(#), #, #, #, #, #)", header: stringConversionCode.} ## \
...
proc newCConstrainPosHprInterval*(name: string, duration: float64, node: NodePath, target: NodePath, wrt: bool, posOffset: LVecBase3, hprOffset: LVecBase3): CConstrainPosHprInterval {.importcpp: "new CConstrainPosHprInterval(nimStringToStdString(#), #, #, #, #, #, #)", header: stringConversionCode.} ## \
...
proc newCConstrainPosHprInterval*(name: string, duration: float64, node: NodePath, target: NodePath, wrt: bool, posOffset: LVecBase3): CConstrainPosHprInterval {.importcpp: "new CConstrainPosHprInterval(nimStringToStdString(#), #, #, #, #, #)", header: stringConversionCode.} ## \
## Constructs a constraint interval that will constrain the position and
## orientation of one node to the position and orientation of another.
##
## If wrt is true, the node's position and orientation will be transformed
...
proc newCConstrainPosInterval*(name: string, duration: float64, node: NodePath, target: NodePath, wrt: bool, posOffset: LVecBase3): CConstrainPosInterval {.importcpp: "new CConstrainPosInterval(nimStringToStdString(#), #, #, #, #, #)", header: stringConversionCode.} ## \
...
proc setStartPos*(this: CLerpNodePathInterval, pos: LVecBase3) {.importcpp: "#->set_start_pos(#)".} ## \
...
proc setEndPos*(this: CLerpNodePathInterval, pos: LVecBase3) {.importcpp: "#->set_end_pos(#)".} ## \
...
proc setStartHpr*(this: CLerpNodePathInterval, hpr: LVecBase3) {.importcpp: "#->set_start_hpr(#)".} ## \
...
proc setEndHpr*(this: CLerpNodePathInterval, hpr: LVecBase3) {.importcpp: "#->set_end_hpr(#)".} ## \
## Indicates that the rotation of the node should be lerped, and specifies the
## final rotation of the node.  This should be called before
## priv_initialize().
##
...
proc setEndQuat*(this: CLerpNodePathInterval, hpr: LVecBase3) {.importcpp: "#->set_end_quat(#)".} ## \
## Indicates that the rotation of the node should be lerped, and specifies the
## final rotation of the node.  This should be called before
## priv_initialize().
##
...
proc setStartScale*(this: CLerpNodePathInterval, scale: LVecBase3) {.importcpp: "#->set_start_scale(#)".} ## \
...
proc setEndScale*(this: CLerpNodePathInterval, scale: LVecBase3) {.importcpp: "#->set_end_scale(#)".} ## \
...
proc setStartShear*(this: CLerpNodePathInterval, shear: LVecBase3) {.importcpp: "#->set_start_shear(#)".} ## \
...
proc setEndShear*(this: CLerpNodePathInterval, shear: LVecBase3) {.importcpp: "#->set_end_shear(#)".} ## \
...
proc setStartColor*(this: CLerpNodePathInterval, color: LVecBase4) {.importcpp: "#->set_start_color(#)".} ## \
...
proc setEndColor*(this: CLerpNodePathInterval, color: LVecBase4) {.importcpp: "#->set_end_color(#)".} ## \
...
proc setStartColorScale*(this: CLerpNodePathInterval, color_scale: LVecBase4) {.importcpp: "#->set_start_color_scale(#)".} ## \
...
proc setEndColorScale*(this: CLerpNodePathInterval, color_scale: LVecBase4) {.importcpp: "#->set_end_color_scale(#)".} ## \
...
proc setStartTexOffset*(this: CLerpNodePathInterval, tex_offset: LVecBase2) {.importcpp: "#->set_start_tex_offset(#)".} ## \
...
proc setEndTexOffset*(this: CLerpNodePathInterval, tex_offset: LVecBase2) {.importcpp: "#->set_end_tex_offset(#)".} ## \
...
proc setStartTexScale*(this: CLerpNodePathInterval, tex_scale: LVecBase2) {.importcpp: "#->set_start_tex_scale(#)".} ## \
...
proc setEndTexScale*(this: CLerpNodePathInterval, tex_scale: LVecBase2) {.importcpp: "#->set_end_tex_scale(#)".} ## \
...
proc addVertex*(this: CMotionTrail, vertex: LVector4, start_color: LVector4, end_color: LVector4, v: float32) {.importcpp: "#->add_vertex(#, #, #, #)".} ## \
## Add a vertex.
