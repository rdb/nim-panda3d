...
converter initLVecBase2f*[T0, T1: SomeNumber](args: tuple[x: T0, y: T1]): LVecBase2f = LVecBase2f(x: args.x, y: args.y)
...
converter initLVecBase2d*[T0, T1: SomeNumber](args: tuple[x: T0, y: T1]): LVecBase2d = LVecBase2d(x: args.x, y: args.y)
...
converter initLVecBase2i*[T0, T1: int | int32](args: tuple[x: T0, y: T1]): LVecBase2i = LVecBase2i(x: args.x, y: args.y)
...
converter initLVecBase3f*[T0, T1, T2: SomeNumber](args: tuple[x: T0, y: T1, z: T2]): LVecBase3f = LVecBase3f(x: args.x, y: args.y, z: args.z)
...
converter initLVecBase3d*[T0, T1, T2: SomeNumber](args: tuple[x: T0, y: T1, z: T2]): LVecBase3d = LVecBase3d(x: args.x, y: args.y, z: args.z)
...
converter initLVecBase3i*[T0, T1, T2: int | int32](args: tuple[x: T0, y: T1, z: T2]): LVecBase3i = LVecBase3i(x: args.x, y: args.y, z: args.z)
...
converter initLVecBase4f*[T0, T1, T2, T3: SomeNumber](args: tuple[x: T0, y: T1, z: T2, w: T3]): LVecBase4f = LVecBase4f(x: args.x, y: args.y, z: args.z, w: args.w)
...
converter initLVecBase4d*[T0, T1, T2, T3: SomeNumber](args: tuple[x: T0, y: T1, z: T2, w: T3]): LVecBase4d = LVecBase4d(x: args.x, y: args.y, z: args.z, w: args.w)
...
converter initLVecBase4i*[T0, T1, T2, T3: int | int32](args: tuple[x: T0, y: T1, z: T2, w: T3]): LVecBase4i = LVecBase4i(x: args.x, y: args.y, z: args.z, w: args.w)
...
converter initUnalignedLVecBase4f*[T0, T1, T2, T3: SomeNumber](args: tuple[x: T0, y: T1, z: T2, w: T3]): UnalignedLVecBase4f = UnalignedLVecBase4f(x: args.x, y: args.y, z: args.z, w: args.w)
...
converter initUnalignedLVecBase4d*[T0, T1, T2, T3: SomeNumber](args: tuple[x: T0, y: T1, z: T2, w: T3]): UnalignedLVecBase4d = UnalignedLVecBase4d(x: args.x, y: args.y, z: args.z, w: args.w)
...
converter initUnalignedLVecBase4i*[T0, T1, T2, T3: int | int32](args: tuple[x: T0, y: T1, z: T2, w: T3]): UnalignedLVecBase4i = UnalignedLVecBase4i(x: args.x, y: args.y, z: args.z, w: args.w)
